 ...
 *
 * State:
 *   State file: <project-root>/.gstackplusplus/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.gstackplusplus/browse-{console,network,dialog}.log
