...
## Step 3: Write CODEX.md snippet

Write this to the project's `CODEX.md` under a `## gstack++ (Codex)` section (create the file if it does not exist — Codex reads `CODEX.md` for project-level instructions):
