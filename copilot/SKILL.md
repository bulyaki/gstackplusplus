...
| `/document-release` | Update README/ARCHITECTURE/CLAUDE.md after shipping |
...
different platforms and must stay in sync. The `/document-release` skill should
...
| `/document-release` | ✅ Full | Copilot Edits | Updates both CLAUDE.md and copilot-instructions.md |
